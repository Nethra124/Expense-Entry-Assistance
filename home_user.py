...
def index():
    ...
    doughnut_layout = go.Layout(height = 600, width = 800, legend=dict(orientation="h", x=-0.5, y=2))
    ...
    return render_template('index_user.html', pname = pname, all_report_data = all_report_data, all_expense_data = all_expense_data, doughnut_graphJSON=doughnut_graphJSON)
